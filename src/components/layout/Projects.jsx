...
// import { imageMap } from "../../../public/projects/";
    ...
    <section id="portfolio" className="py-16 md:py-24 bg-zinc-950">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <a
            href="https://github.com/kodeman14"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-dark-800 hover:bg-dark-700 text-white font-semibold py-3 px-6 rounded-lg border border-dark-700 hover:border-cyan-500/50 transition-colors"
          >
